...
import {Pausable} from "@eigenlayer/src/contracts/permissions/Pausable.sol";
    ...
    ISignatureUtils
{
    ...
    constructor(
        ...
        RegistryCoordinatorStorage(_serviceManager, _stakeRegistry, _macPubkeyRegistry, _indexRegistry)
    ...
    function initialize(
        ...
        registries.push(address(macPubkeyRegistry));
    ...
    *******************************************************************************/
    ...
    function registerOperator(
        ...
        IMACPubkeyRegistry.PubkeyRegistrationParams calldata params,
        SignatureWithSaltAndExpiry memory operatorSignature
    ) external onlyWhenNotPaused(PAUSED_REGISTER_OPERATOR) {
        /**
         * If the operator has NEVER registered a pubkey before, use `params` to register
         * their pubkey in macPubkeyRegistry
         *
    ...
    *******************************************************************************/
    ...
    function _registerOperator(
        ...
        macPubkeyRegistry.registerOperator(operator, quorumNumbers);
    ...
    function _getOrCreateOperatorId(
        ...
        operatorId = macPubkeyRegistry.getOperatorId(operator);
        if (operatorId == 0) {
            operatorId = macPubkeyRegistry.registerMACPubkey(operator, params);
        }
        return operatorId;
    }
    ...
    function _deregisterOperator(
        ...
        macPubkeyRegistry.deregisterOperator(operator, quorumNumbers);
    ...
    *******************************************************************************/
    ...
    function getOperatorFromId(bytes32 operatorId) external view returns (address) {
        return macPubkeyRegistry.getOperatorFromPubkeyHash(operatorId);
    }
