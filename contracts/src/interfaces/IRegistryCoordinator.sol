...
import {IMACPubkeyRegistry} from "./IMACPubkeyRegistry.sol";
...
interface IRegistryCoordinator {
    ...
    /// @notice the MAC Pubkey Registry contract that will keep track of operators' pubkeys in MAC per quorum
    function macPubkeyRegistry() external view returns (IMACPubkeyRegistry);
